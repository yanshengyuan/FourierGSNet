#Implemented by Qiuliang Ye: https://github.com/Qiustander/SiPRNet
...
class SiSPRNet(nn.Module):
    def __init__(self):
        super(SiSPRNet, self).__init__()
        in_dim = 1
        out_dim = 1
        in_size = 427
        dim = 32
        ...
        self.upsample1 = nn.Sequential(
                ...
                nn.Upsample(scale_factor=6.67, mode='bilinear', align_corners=False),
